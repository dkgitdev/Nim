  ...
  framePtr = F;
    ...
    Label2: {
      ...
      Label3: {
        F.line = 120;
          Label4: while (true) {
          if (!(i_654311472 < n_301990053)) break Label4;
            F.line = 49;
            iHEX60gensym4_301990068 = i_654311472;
            F.line = 49;
            ...
            F.line = 122;
            i_654311472 = addInt(i_654311472, 1);
          }
      };
    };
  framePtr = F.prev;
...
function auxWriteStackTrace_33556496(f_33556497) {
  var result_33556498 = [[]];
    ...
    Label5: {
      var j_33556542 = 0;
      var colontmp__654311464 = 0;
      colontmp__654311464 = (i_33556507 - 1);
      var res_654311466 = colontmp__654311464;
      Label6: {
          Label7: while (true) {
          if (!(0 <= res_654311466)) break Label7;
            j_33556542 = res_654311466;
...
framePtr = F;
F.line = 61;
var data_654311426 = new FormData();
F.line = 61;
data_654311426.set("key0", "value0");
F.line = 61;
data_654311426.append("key1", "value1");
F.line = 61;
data_654311426.delete("key1");
if (!(data_654311426.has("key0"))) {
F.line = 61;
failedAssertImpl_268435515(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsformdata_examples_1.nim(12, 3) `data.hasKey(\"key0\")` "));
}

if (!((data_654311426.get("key0") == "value0"))) {
F.line = 61;
failedAssertImpl_268435515(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsformdata_examples_1.nim(13, 3) `data[\"key0\"] == \"value0\".cstring` "));
}

F.line = 61;
(() => { const frmdt = data_654311426; Array.from(frmdt.keys()).forEach((key) => frmdt.delete(key)) })();
if (!((Array.from(data_654311426.entries()).length == 0))) {
F.line = 61;
failedAssertImpl_268435515(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsformdata_examples_1.nim(15, 3) `data.len == 0` "));
}
