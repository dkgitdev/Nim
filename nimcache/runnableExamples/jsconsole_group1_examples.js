  ...
  framePtr = F;
    ...
    Label2: {
      ...
      Label3: {
        F.line = 120;
          Label4: while (true) {
          if (!(i_654311459 < n_301990053)) break Label4;
            F.line = 49;
            iHEX60gensym4_301990068 = i_654311459;
            F.line = 49;
            ...
            F.line = 122;
            i_654311459 = addInt(i_654311459, 1);
          }
      };
    };
  framePtr = F.prev;
...
function auxWriteStackTrace_33556496(f_33556497) {
  var result_33556498 = [[]];
    ...
    Label5: {
      var j_33556542 = 0;
      var colontmp__654311451 = 0;
      colontmp__654311451 = (i_33556507 - 1);
      var res_654311453 = colontmp__654311451;
      Label6: {
          Label7: while (true) {
          if (!(0 <= res_654311453)) break Label7;
            j_33556542 = res_654311453;
...
if (false) {
F.line = 101;
failedAssertImpl_268435515(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsconsole_examples_2.nim(11, 3) `42 == 42` "));
}
