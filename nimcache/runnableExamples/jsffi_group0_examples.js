  ...
  framePtr = F;
    ...
    Label2: {
      ...
      Label3: {
        F.line = 120;
          Label4: while (true) {
          if (!(i_922746918 < n_301990053)) break Label4;
            F.line = 49;
            iHEX60gensym4_301990068 = i_922746918;
            F.line = 49;
            ...
            F.line = 122;
            i_922746918 = addInt(i_922746918, 1);
          }
      };
    };
  framePtr = F.prev;
...
function auxWriteStackTrace_33556496(f_33556497) {
  var result_33556498 = [[]];
    ...
    Label5: {
      var j_33556542 = 0;
      var colontmp__922746910 = 0;
      colontmp__922746910 = (i_33556507 - 1);
      var res_922746912 = colontmp__922746910;
      Label6: {
          Label7: while (true) {
          if (!(0 <= res_922746912)) break Label7;
            j_33556542 = res_922746912;
...
F.line = 224;
obj_922746882.a = 20;
if (!(((obj_922746882.a) == 20))) {
F.line = 224;
failedAssertImpl_268435515(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsffi_examples_2.nim(10, 3) `obj.a.to(int) == 20` "));
}
